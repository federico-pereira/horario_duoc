...
def visualize(combo):
    ...
    for sec in combo:
        ...
        for d, s, e in sec.meetings:
            ...
            ax.add_patch(patches.Rectangle((x+0.05,y0),0.9,h,
...
st.sidebar.header("Rango horario preferido")
...
def generate():
    st.session_state.scored = compute_schedules(sub, ranking_map, min_free, banned,
